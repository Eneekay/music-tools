(function () {
  ...
  /* =========================================================================
     Note theory: name <-> MIDI <-> frequency, with A4 reference + fine detune
     ========================================================================= */
  ...
  function midiToFreq(midi, refA4, detuneCents) {
    var effectiveA4 = refA4 * Math.pow(2, (detuneCents || 0) / 1200);
  ...
  function runDetection() {
    ...
    var freq = autoCorrelate(pitchBuffer, audioCtx.sampleRate);
